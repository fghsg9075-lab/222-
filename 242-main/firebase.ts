...
import { getFirestore, doc, setDoc, getDoc, collection, updateDoc, deleteDoc, onSnapshot, getDocs, query, where, limitToLast, orderBy } from "firebase/firestore";
...
export const getChapterData = async (key: string) => {
    try {
        ...
        if (docSnap.exists()) {
            ...
            // Cache in localStorage for offline/speed

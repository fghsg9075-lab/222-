                            ...
                            <div
                                ...
                                onClick={() => {
                                    if (onNavigateToChapter) {
                                        onNavigateToChapter(h.chapterId, h.chapterTitle, h.subjectName, h.classLevel);
                                    } else {
                                        setSelectedResult(h);
                                    }
                                }}
                                className="flex justify-between items-center bg-green-50/50 p-2 rounded-lg border border-green-100 cursor-pointer hover:bg-green-100 transition-all"
                            >
                    ...
                    {categorizedHistory.average.length === 0 ? (
                        ...
                        <div className="space-y-2">
                            ...
                            <div
                                ...
                                className="flex justify-between items-center bg-yellow-50/50 p-2 rounded-lg border border-yellow-100 cursor-pointer hover:bg-yellow-100 transition-all"
                            >
                                <span className="text-[11px] font-bold text-slate-700 truncate flex-1 mr-2">{h.chapterTitle}</span>
                    ...
                    {categorizedHistory.weak.length === 0 ? (
                        ...
                        <div className="space-y-2">
                            ...
                            <div
                                ...
                                className="flex justify-between items-center bg-red-50/50 p-2 rounded-lg border border-red-100 cursor-pointer hover:bg-red-100 transition-all"
                            >
                                <span className="text-[11px] font-bold text-slate-700 truncate flex-1 mr-2">{h.chapterTitle}</span>
                ...
                <div className="space-y-3">
                    ...
                    {history.map((item) => (
                        <div
                            ...
                            onClick={() => {
                                if (onNavigateToChapter) {
                                    onNavigateToChapter(item.chapterId, item.chapterTitle, item.subjectName, item.classLevel);
                                } else {
                                    setSelectedResult(item);
                                }
                            }}
                            className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col gap-3 cursor-pointer hover:border-blue-300 transition-all group"
                        >
                            ...
                            <div className="flex gap-2">
                                ...
                                <button
                                    className="flex-1 py-2 bg-blue-600 text-white rounded-lg text-xs font-bold flex items-center justify-center gap-2 hover:bg-blue-700 transition-colors"
                                >

...
import { BookOpen, Calendar, ChevronDown, ChevronUp, Trash2, Search, FileText, CheckCircle2, Lock, AlertCircle } from 'lucide-react';
                        ...
                        <div
                            ...
                            onClick={() => {
                                ...
                                let pseudoItem: LessonContent = {
                                    ...
                                    content: '',
                                    type: log.type === 'VIDEO' ? 'VIDEO_LECTURE' : log.type === 'MCQ' ? 'MCQ_ANALYSIS' : 'NOTES_SIMPLE',
                                ...
                                // ENHANCEMENT: Try to find actual content links from settings to fix "No Content" error
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-2 mt-1">
                                        ...
                                        {log.type === 'MCQ' && log.score !== undefined && (
                                            <p className="text-[10px] font-black text-indigo-600">Score: {log.score}/{log.totalQuestions}</p>
                                        )}
                                        {log.type === 'PURCHASE' && log.amount && (
                                            <p className="text-[10px] font-black text-emerald-600">Amount: {log.amount} CR</p>
                                        )}
                                    </div>
                                </div>
                            </div>
                            <div className="text-right">
                                {log.type === 'MCQ' ? (
                                    <div className="flex flex-col items-end gap-1">
                                        <span className="text-xs font-bold text-indigo-600 bg-indigo-50 px-2 py-1 rounded-full border border-indigo-100">Review</span>

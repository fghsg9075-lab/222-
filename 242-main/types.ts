...
export type ContentType = 'NOTES_SIMPLE' | 'NOTES_PREMIUM' | 'MCQ_ANALYSIS' | 'MCQ_SIMPLE' | 'PDF_FREE' | 'PDF_PREMIUM' | 'PDF_ULTRA' | 'PDF_VIEWER' | 'WEEKLY_TEST' | 'VIDEO_LECTURE' | 'NOTES_HTML_FREE' | 'NOTES_HTML_PREMIUM' | 'NOTES_IMAGE_AI' | 'AUDIO';
...
export interface SystemSettings {
  ...
  customCSS?: string;
  apiKeys?: any[];
  aiProviders?: AIProviderConfig[]; // NEW: Multi-Provider Config
  aiCanonicalMapping?: Record<string, { providerId: string, modelId: string }>; // NEW: Canonical Mapping
  adminCode?: string;
  adminEmail?: string;
...
export type StudentTab = 'HOME' | 'COURSES' | 'ROUTINE' | 'HISTORY' | 'REDEEM' | 'PREMIUM' | 'GAME' | 'WEEKLY_TEST' | 'PROFILE' | 'LEADERBOARD' | 'STORE' | 'VIDEO' | 'PDF' | 'MCQ' | 'ANALYTICS' | 'PRIZES' | 'REWARDS' | 'UPDATES' | 'SUB_HISTORY' | 'AUDIO';
